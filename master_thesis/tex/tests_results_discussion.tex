...
Radius & Sharp & \multicolumn{1}{l|}{Prec.} & $\sigma = $0.2 & \multicolumn{1}{l|}{Rel. Diff.} & $\sigma = $0.1 & \multicolumn{1}{l|}{Rel. Diff.} \\ \hline
...
\begin{figure}[!htb]
  ...
  \caption[Relative difference of shifted radius \ce{H_2O} against Gaussian double augmented results]{Relative difference between the Reaction field energy of \ce{H_2O} in a water solution calculated with with relative precision $e-05$ in \mrchem
  and with double augmented basis sets in Gaussian}
...
\begin{figure}[!htb]
  ...
  \caption[Relative difference of shifted radius \ce{Li^+} against Gaussian double augmented results]{Relative difference between the Reaction field energy of \ce{Li^+} in a water solution calculated with relative precision $e-05$ in \mrchem
  and with double augmented basis sets in Gaussian}
